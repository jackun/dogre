module ogregl.hardwareindexbuffer;
...
class GLHardwareIndexBuffer : HardwareIndexBuffer
{
private:
    GLuint mBufferId;
...
protected:
    ...
    override void* lockImpl(size_t offset, size_t length, LockOptions options)
    {
        ...
        debug(STDERR) std.stdio.stderr.writeln(__FILE__,"@",__LINE__,": lockImpl :", retPtr, ", ", offset," - ", length);
        mIsLocked = true;
        return retPtr;
    }
...
public:
    this(HardwareBufferManagerBase mgr, IndexType idxType, size_t numIndexes, 
                          HardwareBuffer.Usage usage, bool useShadowBuffer)
    {
        super(mgr, idxType, numIndexes, usage, false, useShadowBuffer);
    ...
    override void _updateFromShadow()
    {
        if (mUseShadowBuffer && mShadowUpdated && !mSuppressHardwareUpdate)
        {
            ...
            {
                glBufferSubData(GL_ELEMENT_ARRAY_BUFFER, mLockStart, mLockSize, srcData);
            }
