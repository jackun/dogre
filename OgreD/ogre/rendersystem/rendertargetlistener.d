module ogre.rendersystem.rendertargetlistener;
...
/** A interface class defining a listener which can be used to receive
    ...
    */
interface RenderTargetListener
{
    /*
    ...
    /** Called just before a RenderTarget is about to be rendered into.
        ...
        */
    void preRenderTargetUpdate(RenderTargetEvent evt); //TODO To ref or not?
    ...
    /** Called just after a RenderTarget has been rendered to.
        @remarks
            ...
            you use etc).
        */
    void postRenderTargetUpdate(RenderTargetEvent evt); //TODO To ref or not?
    ...
    /* Called just before a Viewport on a RenderTarget is to be updated.
        ...
        */
    void preViewportUpdate(RenderTargetViewportEvent evt); //TODO To ref or not?
    ...
    /* Called just after a Viewport on a RenderTarget is to be updated.
        @remarks
            ...
            rendered to. 
        */
    void postViewportUpdate(RenderTargetViewportEvent evt); //TODO To ref or not?
    
    /** Called to notify listener that a Viewport has been added to the 
            target in question.
        */
    void viewportAdded(RenderTargetViewportEvent evt); //TODO To ref or not?

    /** Called to notify listener that a Viewport has been removed from the 
            target in question.
        */
    void viewportRemoved(RenderTargetViewportEvent evt); //TODO To ref or not?
}