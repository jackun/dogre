...
extern(System)
{
    ...
    //Added. old stuf
    alias nothrow void function (GLhandleARB, const (GLcharARB*)) da_glGetAttribLocationARB;
}
...
__gshared
{
    ...
    da_glGetAttribLocationARB glGetAttribLocationARB;
}
...
extern(System)
{
    ...
    //Added. Old stuff
    alias nothrow void function (GLenum,GLuint) da_glBindProgramARB;
    alias nothrow void function (GLsizei, const(GLuint*) programs) da_glDeleteProgramsARB;
    alias nothrow void function (GLenum,GLuint,const(GLfloat*)) da_glProgramLocalParameter4fvARB;
    alias nothrow void function (GLenum,GLenum,GLsizei, const(void*)) da_glProgramStringARB;
    //alias nothrow void function (GLhandleARB) da_glDeleteObjectARB;
    //alias nothrow void function (GLhandleARB) da_glUseProgramObjectARB;
...
__gshared
{
    ...
    //Added.
    da_glBindProgramARB glBindProgramARB;
    da_glDeleteProgramsARB glDeleteProgramsARB;
    da_glProgramLocalParameter4fvARB glProgramLocalParameter4fvARB;
    da_glProgramStringARB glProgramStringARB;
    //da_glDeleteObjectARB glDeleteObjectARB;
    //da_glUseProgramObjectARB glUseProgramObjectARB;
}
