    ...
    public
    {
        override GLVersion reload()
        {
            ...
            if(maxVer >= GLVersion.GL12)
            {
                ...
                //Added. old stuff
                bindGLFunc(cast(void**)&glGetAttribLocationARB, "glGetAttribLocationARB");
            }
            ...
            if(maxVer >= GLVersion.GL13)
            {
                ...
                //Added. Old stuff
                bindGLFunc(cast(void**)&glBindProgramARB, "glBindProgramARB");
                bindGLFunc(cast(void**)&glDeleteProgramsARB, "glDeleteProgramsARB");
                bindGLFunc(cast(void**)&glProgramLocalParameter4fvARB, "glProgramLocalParameter4fvARB");
                bindGLFunc(cast(void**)&glProgramStringARB, "glProgramStringARB");
                //In 1.2 ?
                //bindGLFunc(cast(void**)&glDeleteObjectARB, "glDeleteObjectARB");
                //bindGLFunc(cast(void**)&glUseProgramObjectARB, "glUseProgramObjectARB");
            }
