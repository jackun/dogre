...
extern(System)
{
    alias nothrow void function(GLsizei n, GLuint* programs) da_glGenProgramsARB;
}
__gshared
{
    da_glGenProgramsARB glGenProgramsARB;
}
private __gshared bool _ARB_vertex_program;
bool ARB_vertex_program() @property { return _ARB_vertex_program; }
package void load_ARB_vertex_program(bool doThrow = false)
{
    try
    {
        bindGLFunc(cast(void**)&glGenProgramsARB, "glGenProgramsARB");
        _ARB_vertex_program = true;
    }
    catch(Exception e)
    {
        if(doThrow) throw e;
...
// TODO Added. Not in vanilla Derelict3 :/
// ARB_vertex_buffer_object
extern(System)
{
    alias nothrow void function(GLenum,GLuint) da_glBindBufferARB;
    alias nothrow void function(GLenum,GLsizeiptrARB,const(GLvoid*),GLenum) da_glBufferDataARB;
    alias nothrow void function(GLenum,GLintptrARB, GLsizeiptrARB,const GLvoid*) da_glBufferSubDataARB;
    alias nothrow void function(GLsizei,const(GLuint*)) da_glDeleteBuffersARB;
    alias nothrow void function(GLsizei,GLuint*) da_glGenBuffersARB;
    alias nothrow void function(GLenum,GLenum,GLint*) da_glGetBufferParameterivARB;
    alias nothrow void function(GLenum,GLenum,GLvoid**) da_glGetBufferPointervARB;
    alias nothrow void function(GLenum,GLintptrARB,GLsizeiptrARB,GLvoid*) da_glGetBufferSubDataARB;
    alias nothrow GLboolean function(GLuint) da_glIsBufferARB;
    alias nothrow GLvoid* function(GLenum,GLenum) da_glMapBufferARB;
    alias nothrow GLboolean function(GLenum) da_glUnmapBufferARB;
}

__gshared
{
    da_glBindBufferARB glBindBufferARB;
    da_glBufferDataARB glBufferDataARB;
    da_glBufferSubDataARB glBufferSubDataARB;
    da_glDeleteBuffersARB glDeleteBuffersARB;
    da_glGenBuffersARB glGenBuffersARB;
    da_glGetBufferParameterivARB glGetBufferParameterivARB;
    da_glGetBufferPointervARB glGetBufferPointervARB;
    da_glGetBufferSubDataARB glGetBufferSubDataARB;
    da_glIsBufferARB glIsBufferARB;
    da_glMapBufferARB glMapBufferARB;
    da_glUnmapBufferARB glUnmapBufferARB;
}

private __gshared bool _ARB_vertex_buffer_object;
bool ARB_vertex_buffer_object() @property { return _ARB_vertex_buffer_object; }

package void load_ARB_vertex_buffer_object(bool doThrow = false)
{
    try
    {   //May need ARB suff?
        bindGLFunc(cast(void**)&glBufferDataARB,"glBufferDataARB");
        bindGLFunc(cast(void**)&glBufferSubDataARB,"glBufferSubDataARB");
        bindGLFunc(cast(void**)&glDeleteBuffersARB,"glDeleteBuffersARB");
        bindGLFunc(cast(void**)&glGenBuffersARB,"glGenBuffersARB");
        bindGLFunc(cast(void**)&glGetBufferParameterivARB,"glGetBufferParameterivARB");
        bindGLFunc(cast(void**)&glGetBufferPointervARB,"glGetBufferPointervARB");
        bindGLFunc(cast(void**)&glGetBufferSubDataARB,"glGetBufferSubDataARB");
        bindGLFunc(cast(void**)&glIsBufferARB,"glIsBufferARB");
        bindGLFunc(cast(void**)&glMapBufferARB,"glMapBufferARB");
        
        _ARB_vertex_buffer_object = true;
    }
    catch(Exception e)
    {
        if(doThrow) throw e;
...
extern(System)
{
    alias nothrow void function(GLenum target, GLenum pname, GLint* params) da_glGetProgramivARB;
}
__gshared 
{
    da_glGetProgramivARB glGetProgramivARB;
}
package void load_ARB_misc_arb(bool doThrow = false)
{
    try
    {
        bindGLFunc(cast(void**)&glGetProgramivARB, "glGetProgramivARB");
    }
    catch(Exception e)
    {
        if(doThrow) throw e;
...
private __gshared bool _ARB_instanced_arrays; bool ARB_instanced_arrays() @property { return _ARB_instanced_arrays; }
private __gshared bool _ARB_texture_env_combine; bool ARB_texture_env_combine() @property { return _ARB_texture_env_combine; }
private __gshared bool _ARB_multitexture; bool ARB_multitexture() @property { return _ARB_multitexture; }
private __gshared bool _ARB_fragment_program; bool ARB_fragment_program() @property { return _ARB_fragment_program; }
private __gshared bool _ARB_texture_env_dot3; bool ARB_texture_env_dot3() @property { return _ARB_texture_env_dot3; }
private __gshared bool _ARB_texture_cube_map; bool ARB_texture_cube_map() @property { return _ARB_texture_cube_map; }
private __gshared bool _ARB_point_sprite; bool ARB_point_sprite() @property { return _ARB_point_sprite; }
private __gshared bool _ARB_point_parameters; bool ARB_point_parameters() @property { return _ARB_point_parameters; }
private __gshared bool _ARB_occlusion_query; bool ARB_occlusion_query() @property { return _ARB_occlusion_query; }
private __gshared bool _ARB_texture_compression; bool ARB_texture_compression() @property { return _ARB_texture_compression; }
private __gshared bool _ARB_pixel_buffer_object; bool ARB_pixel_buffer_object() @property { return _ARB_pixel_buffer_object; }
private __gshared bool _ARB_texture_float; bool ARB_texture_float() @property { return _ARB_texture_float; }
...
private __gshared bool _ARB_shading_language_100; bool ARB_shading_language_100() @property { return _ARB_shading_language_100; }
private __gshared bool _ARB_shader_objects; bool ARB_shader_objects() @property { return _ARB_shader_objects; }
private __gshared bool _ARB_fragment_shader; bool ARB_fragment_shader() @property { return _ARB_fragment_shader; }
...
{
    //XXX Added. Not in vanilla Derelict3. Probably would need to check for some glversion
    _ARB_vertex_shader          = isExtSupported(glversion, "GL_ARB_vertex_shader");
    _ARB_fragment_shader        = isExtSupported(glversion, "GL_ARB_fragment_shader");
    _ARB_shader_objects         = isExtSupported(glversion, "GL_ARB_shader_objects");
    _ARB_shading_language_100   = isExtSupported(glversion, "GL_ARB_shading_language_100");
    _ARB_vertex_buffer_object   = isExtSupported(glversion, "GL_ARB_vertex_buffer_object");
    _ARB_vertex_program         = isExtSupported(glversion, "GL_ARB_vertex_program");
    _ARB_draw_buffers           = isExtSupported(glversion, "GL_ARB_draw_buffers");
    _ARB_texture_non_power_of_two = isExtSupported(glversion, "GL_ARB_texture_non_power_of_two");
    _ARB_texture_float          = isExtSupported(glversion, "GL_ARB_texture_float");
    _ARB_pixel_buffer_object    = isExtSupported(glversion, "GL_ARB_pixel_buffer_object");
    _ARB_instanced_arrays       = isExtSupported(glversion, "GL_ARB_instanced_arrays");//in functions.d
    _ARB_texture_compression    = isExtSupported(glversion, "GL_ARB_texture_compression");
    _ARB_occlusion_query        = isExtSupported(glversion, "GL_ARB_occlusion_query");
    _ARB_point_parameters       = isExtSupported(glversion, "GL_ARB_point_parameters");
    _ARB_point_sprite           = isExtSupported(glversion, "GL_ARB_point_sprite");
    _ARB_texture_env_combine    = isExtSupported(glversion, "GL_ARB_texture_env_combine");
    _ARB_multitexture           = isExtSupported(glversion, "GL_ARB_multitexture");
    _ARB_fragment_program       = isExtSupported(glversion, "GL_ARB_fragment_program");
    _ARB_vertex_program         = isExtSupported(glversion, "GL_ARB_vertex_program");
    _ARB_texture_env_dot3       = isExtSupported(glversion, "GL_ARB_texture_env_dot3");
    _ARB_texture_cube_map       = isExtSupported(glversion, "GL_ARB_texture_cube_map");
    
    if(_ARB_vertex_program)         load_ARB_vertex_program();
    if(_ARB_vertex_buffer_object)   load_ARB_vertex_buffer_object();
    load_ARB_misc_arb();
    //end-of-Added. Not in vanilla Derelict3.
